...
import edu.epidata.todo.log.Log;
...
public class LogServiceTest {
    ...
    /**
     * Este m�todo se ejecuta SIEMPRE antes de CADA @Test
     */
    @Before
    public void setup() {
    ...
    /**
     * Agrega todos los eventos al log y chequea que coincida el tamao de los
